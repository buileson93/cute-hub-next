...
function createSupabaseClient() {
  ...
  if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY) {
    ...
    // return a dummy client or just log instead of throwing during SSR if possible
    // but the original code threw, so we keep the throw but guard the process.env access
