...
export const UI_DENSITY = {
  // --- Spacing & Layout ---
  PAGE_PADDING:
    "p-2 md:p-3 data-[density=comfortable]:p-4 md:data-[density=comfortable]:p-6 data-[density=spacious]:p-6 md:data-[density=spacious]:p-8",
  SECTION_GAP:
    "gap-2 md:gap-2 md:data-[density=comfortable]:gap-4 md:data-[density=spacious]:gap-6",
  ...
  CARD_HEADER:
    "px-3 pt-3 pb-1 data-[density=comfortable]:px-5 data-[density=comfortable]:pt-5 data-[density=comfortable]:pb-3",

  // --- KPI ---
  KPI_LABEL_FS: "text-[11px] data-[density=comfortable]:text-[13px] text-muted-foreground",
  KPI_VALUE_FS:
    "text-[18px] data-[density=comfortable]:text-[22px] data-[density=spacious]:text-[26px] font-bold tabular-nums",
  ...
  ICON_MD:
    "h-3.5 w-3.5 data-[density=comfortable]:h-4.5 data-[density=comfortable]:w-4.5 data-[density=spacious]:h-5 data-[density=spacious]:w-5",

  // --- Typography (Plex Mono for numbers/code) ---
  TEXT_BODY:
    "text-[12px] data-[density=comfortable]:text-[14px] data-[density=spacious]:text-[15px] leading-relaxed",
  TEXT_LABEL:
    "text-[11px] data-[density=comfortable]:text-[13px] font-medium uppercase tracking-wider",
