...
const rows: ExpiringRow[] = [
  { loai: "bao_hanh", thiet_bi_id: "tb-1", ten: "Máy A", ngay_het_han: "2026-07-20", so_ngay_con_lai: 10 },
  { loai: "giay_phep", thiet_bi_id: "tb-2", ten: "GP B", ngay_het_han: "2026-08-10", so_ngay_con_lai: 31 },
  { loai: "bao_hanh", thiet_bi_id: "tb-3", ten: "Máy C", ngay_het_han: "2026-07-12", so_ngay_con_lai: 2 },
  { loai: "giay_phep", thiet_bi_id: "tb-4", ten: "GP D", ngay_het_han: "2026-07-01", so_ngay_con_lai: -9 },
  { loai: "bao_hanh", thiet_bi_id: "tb-5", ten: "Máy E", ngay_het_han: "2026-12-01", so_ngay_con_lai: 144 },
];
...
describe("locSapHetHan — lọc theo số ngày", () => {
  ...
  it("days = 0 chỉ lấy mục hết hạn hôm nay", () => {
    const withToday: ExpiringRow[] = [
      ...rows,
      { loai: "bao_hanh", thiet_bi_id: "tb-6", ten: "Máy F", ngay_het_han: "2026-07-10", so_ngay_con_lai: 0 },
    ];
