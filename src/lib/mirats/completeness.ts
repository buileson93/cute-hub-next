...
export const CORE_FIELDS: Record<string, string[]> = {
  thiet_bi: ["ten_thiet_bi", "ma_serial", "model_id", "trang_thai_id", "he_thong_id", "don_vi_id"],
  he_thong: ["ten_he_thong", "ma_he_thong", "loai_he_thong_id", "don_vi_id", "nhom_he_thong_id"],
};
