  ...
  <Html lang="vi" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Hr style={hr} />
        <Text style={footer}>
          Email test tự động từ {siteName}. Không cần trả lời.
        </Text>
      </Container>
    </Body>
  </Html>
...
export const template = {
  ...
  subject: (d) =>
    `[${d.siteName ?? 'VATM'}] ${(d.items?.length ?? 0)} cảnh báo cần chú ý`,
...
const row = { margin: '0 0 14px', padding: '10px 12px', backgroundColor: '#f7f7f8', borderRadius: '6px' }
const badge = { fontSize: '11px', fontWeight: 'bold' as const, color: '#b45309', margin: '0 0 4px', textTransform: 'uppercase' as const }
