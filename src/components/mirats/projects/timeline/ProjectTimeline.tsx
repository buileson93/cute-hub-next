...
import {
  ...
  ProjectEvent,
  ProjectEventType,
} from "@/hooks/mirats/use-project-events";
...
function TimelineInspector({ event, onClose }: { event: any; onClose: () => void }) {
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2 text-xs font-medium">
              ...
              <span className="truncate">
                {event.actor?.ho_ten || event.actor?.email || "Hệ thống"}
              </span>
            </div>
          </div>
          <div className="space-y-1.5">
...
function getEventIcon(type: ProjectEventType) {
  switch (type) {
    ...
    case "task_status_changed":
      return Clock;
    case "canvas_published":
      return Layout;
    case "document_uploaded":
      return FileText;
    case "correspondence_created":
      return FileText;
    default:
      return Info;
  }
