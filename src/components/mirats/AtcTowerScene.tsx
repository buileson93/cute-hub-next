    ...
    >
      ...
      <AnimatePresence>
        {peek && (
          ...
          >
            <div className="mb-2 flex items-center gap-2 font-mono text-mini uppercase tracking-[0.24em] text-amber-200/90">
              <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-emerald-400" />
              Đài KSKL · Phù Cát
            </div>
            <div className="mb-3 text-lead font-semibold leading-snug text-white">
              Tháp 45m · Cabin 60m² · VATM
            </div>
            <div className="min-h-[9rem] whitespace-pre-line font-mono text-xs leading-relaxed text-white/85">
      ...
      {/* HUD — top */}
      <div className="pointer-events-none absolute inset-x-0 top-0 flex items-start justify-between p-6 font-mono text-mini uppercase tracking-[0.24em] text-white/85">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-6 flex flex-col items-center gap-2 px-8 text-center">
        <div className="flex items-center gap-2 rounded-full border border-white/25 bg-black/35 px-3 py-1 backdrop-blur">
          <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-emerald-400" />
          <span className="font-mono text-mini uppercase tracking-[0.28em] text-white/85">
...
function AtmMonitor({ time, reduce }: { time: string; reduce: boolean }) {
  ...
  return (
    <div className="pointer-events-none absolute bottom-[calc(2rem+3%)] right-[calc(2rem+3%)] w-[220px] font-mono">
      <div className="mb-2 flex items-center justify-between px-1 text-micro uppercase tracking-[0.24em] text-amber-100/85">
      ...
      <div className="mt-2 flex items-center justify-between px-1 text-micro uppercase tracking-[0.22em] text-amber-100/75">
        <span>
