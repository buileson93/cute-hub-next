  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      <div className="flex items-center gap-2 border-b border-border px-2 py-2">
        ...
        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 text-mini font-semibold text-primary">
          {title.slice(0, 2).toUpperCase()}
        </div>
                ...
                <div key={m.id} className={cn("flex gap-2", mine && "flex-row-reverse")}>
                  <div className="w-7 shrink-0">
                    {showHeader && (
                      <div
                        className={cn(
                          "flex h-7 w-7 items-center justify-center rounded-full text-micro font-semibold",
                  ...
                  <div className={cn("min-w-0 max-w-[78%]", mine && "text-right")}>
                    {showHeader && (
                      <div className="mb-1 text-mini text-muted-foreground">
