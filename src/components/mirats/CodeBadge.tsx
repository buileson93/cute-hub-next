...
export function CodeBadge({
  ...
  return (
    <span
      title={title ?? `Mã: ${c}`}
      className={cn(
        "inline-flex shrink-0 items-center gap-0.5 rounded border border-primary/25 bg-primary/10 px-1 py-0 font-mono text-meta font-bold leading-4 text-primary align-middle",
        className,
      )}
    >
