    ...
    <div className="flex h-full items-center justify-between gap-4 w-full">
      <div className="flex items-center gap-2 flex-1 min-w-0">
        ...
        <div className="relative w-full sm:max-w-sm group" data-tour="search">
          ...
          >
            <span className="truncate pl-1 pr-10">Tìm tài sản, hệ thống, biên bản...</span>
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-primary z-20 group-hover:scale-110 transition-transform" />
            
            <div className="absolute right-3 top-1/2 -translate-y-1/2 hidden items-center gap-1.5 rounded-md border border-border/40 bg-background/50 backdrop-blur-sm px-1.5 py-0.5 font-mono text-[9px] font-bold text-muted-foreground/60 sm:flex z-20">
