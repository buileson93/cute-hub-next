      ...
      <SheetContent side="right" className="flex w-full flex-col sm:max-w-md">
        ...
        >
          ...
          {target?.kind === "nh" && canManage && target.ma !== HT_KHAC && (
            <div className="space-y-1.5">
              <Label htmlFor="edit-group-ma" className="text-xs">
                Mã nhóm hệ thống
              </Label>
              <div className="flex gap-2">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => renameGroupCode.mutate({ ma: target.ma, newMa: groupCode })}
                >
                  {renameGroupCode.isPending ? (
            ...
            <div className="space-y-3 rounded-md border p-3">
              ...
              {canManage && (
                <div className="space-y-2 border-t pt-3">
                  ...
                  <Input
                    value={newGroupMa}
                    onChange={(e) => setNewGroupMa(e.target.value.toUpperCase())}
                    placeholder="Mã nhóm..."
                  />
                  <Button
                    size="sm"
