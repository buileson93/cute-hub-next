...
/**
 * Bảng điều khiển Tổng quan dùng chung cho cả "/" (Trang chủ) và "/tong-quan".
 * Cùng một layout widget, cùng pref key ⇒ hai đường dẫn luôn đồng bộ.
 */
export function OverviewDashboard({ title = "Báo cáo Tổng quan KPI" }: { title?: string }) {
    ...
    <PageFrame density="compact">
      ...
      <div className="flex flex-col shrink-0 px-6 pt-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
          <PageHeader title={title} icon="entity.chart" className="border-b-0 p-0 bg-transparent backdrop-blur-none sticky-none" />
