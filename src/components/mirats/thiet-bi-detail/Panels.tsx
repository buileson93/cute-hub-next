              ...
              metrics.map((m, i) => (
                <TableRow key={i}>
                  <TableCell className="text-xs font-mono">
                    {new Date(m.thoi_diem).toLocaleString("vi-VN")}
                  </TableCell>
...
export function AllocationPanel({
  ...
  thietBiId: string;
  donViTenMap?: Record<string, string>;
}) {
          ...
          <TableBody>
            {isLoading ? (
              ...
              history.map((h, i) => (
                <TableRow key={i}>
                  <TableCell className="text-xs font-mono">
                    {new Date(h.thoi_diem).toLocaleString("vi-VN")}
                  </TableCell>
                  <TableCell>
                    <Badge
                      variant={h.hanh_dong === "cap_phat" ? "default" : "secondary"}
                      className={
                        h.hanh_dong === "cap_phat"
                  ...
                  <TableCell className="text-sm">
                    {h.don_vi_giu_id ? donViTenMap[h.don_vi_giu_id] || h.don_vi_giu_id : "—"}
                  </TableCell>
                </TableRow>
              ))
            )}
              ...
              lifecycle.map((l, i) => (
                <TableRow key={i}>
                  ...
                  <TableCell>
                    ...
                    >
                      {statusMap?.get(l.den_trang_thai_id || "") || l.den_trang_thai_id || "—"}
                    </Badge>
                  </TableCell>
