        ...
        <div className="space-y-3">
          {vaiTroList.length === 0 ? (
            ...
            vaiTroList.map((r) => (
              ...
              >
                <div>
                  <div className="font-bold text-note text-foreground">{r.ten_thanh_phan}</div>
          ...
          {vaiTroList.length >= 2 && (
            <div className="rounded-2xl border border-amber-200/50 bg-amber-500/5 p-4 text-note text-amber-700 dark:text-amber-400 flex items-start gap-3 ring-1 ring-amber-500/20">
