...
export default function TabHoSoPhapLy({
  ...
  return (
    <div className="space-y-6">
      {/* Giấy phép khai thác */}
      <section>
        <h3 className="mb-3 text-meta font-bold uppercase tracking-wider text-muted-foreground/60 flex items-center gap-2 px-1">
          <ShieldCheck className="h-3.5 w-3.5 text-primary" />
          Giấy phép & Chứng chỉ
        </h3>
        <div className="grid gap-4 md:grid-cols-2">
          {hasGp ? (
            <div className="flex items-center justify-between rounded-2xl border p-4 text-note bg-card shadow-sm ring-1 ring-border/50">
            ...
            <div className="rounded-2xl border border-dashed p-8 text-center text-note text-muted-foreground bg-muted/20">
