...
export const roleMeta: Record<RoleKey, {
  name: string; short: string; scope: string; icon: any; tone: string; desc: string;
}> = {
  admin: {
...
export const ROLE_ORDER: RoleKey[] = ["admin", "phong_kt", "phu_trach_dv", "quan_ly_du_an", "to_truong", "ktv", "readonly"];
