  ...
  return (
    ...
    >
      ...
      {d.laCum ? (
        ...
        <>
          {d.don_vi && <div className="truncate text-mini text-muted-foreground">{d.don_vi}</div>}
          {d.benNgoai && d.toChuc && (
            <div className="truncate text-mini italic text-muted-foreground">⧉ {d.toChuc}</div>
          )}
        </>
      )}
