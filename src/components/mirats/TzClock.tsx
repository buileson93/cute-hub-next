    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          aria-label="PLAN MODE FIRST — PERFORMANCE/ARCHITECTURE ONLY.\n\nChỉ thực hiện sau P0/P1 security và data correctness.\n\n1. Bảng:\n\n- áp dụng Prompt 8;\n\n- sửa wrong-row mapping trước;\n\n- một scroll owner;\n\n- client/infinite/paged typed modes;\n\n- mobile virtualization theo benchmark.\n\n2. Realtime:\n\n- subscription phải filter theo user/conversation/project khi API hỗ trợ;\n\n- debounce/coalesce event burst;\n\n- không reload toàn bộ list cho mọi message;\n\n- cleanup channel/listener/timer khi unmount.\n\n3. Tách hotspot theo responsibility, không big-bang:\n\n- NetworkOverview;\n\n- he-thong detail route;\n\n- StandardTable;\n\n- so-do detail route;\n\n- CatalogTable;\n\n- ThanhPhanTable.\n\n4. Mỗi extraction phải có characterization test trước.\n\n5. Giữ adapter API cũ trong thời gian migrate.\n\n6. Đo render count, memory, bundle chunk và interaction latency.\n\n7. Không đổi ngôn ngữ thiết kế hoặc business behavior.\n\nKẾT QUẢ CẦN ĐẠT SAU PROMPT 10I\n\n- Bảng pilot không hiển thị/thao tác sai bản ghi và DOM bị giới hạn theo viewport.\n\n- Realtime chỉ reload dữ liệu liên quan, không tạo reload storm toàn workspace.\n\n- Mọi channel/listener/timer được cleanup khi unmount.\n\n- Ít nhất một hotspot được tách bằng characterization tests mà không đổi hành vi.\n\n- Có số liệu trước/sau về render count, memory, bundle và interaction latency.\n\n- Không big-bang rewrite; adapter cũ vẫn hoạt động trong giai đoạn migration.\n\nCommit nhỏ theo từng hook/component, không commit refactor tổng hợp."
