  ...
  head: () => ({
    meta: [
      { title: "Bảo dưỡng định kỳ (PM) — MIRATS" },
      {
        name: "description",
        content:
          "Hàng đợi công việc bảo dưỡng định kỳ đến hạn theo chính sách PM: sắp đến hạn, đến hạn, quá hạn và hoàn thành.",
      },
      { property: "og:title", content: "Bảo dưỡng định kỳ (PM) — MIRATS" },
      {
        property: "og:description",
        content: "Sinh và theo dõi công việc PM tự động theo chu kỳ chính sách.",
      },
    ],
  }),
  component: PmPage,
    ...
    >
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            {task.chinh_sach?.ten} · hạn {task.han}
          </DialogDescription>
        </DialogHeader>
    ...
    >
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Ghi lý do — chỉ admin/phòng kỹ thuật mới được bỏ qua.
          </DialogDescription>
        </DialogHeader>
        <Textarea
          rows={3}
