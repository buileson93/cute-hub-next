...
export const Route = createFileRoute("/_app/chat-luong-du-lieu")({
  ...
  head: () => ({
    ...
    meta: [
      {
        name: "description",
        content: "Dashboard theo dõi độ hoàn thiện và chất lượng dữ liệu hệ thống",
      },
    ],
  }),
});
              ...
              <div className="space-y-4">
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {item.dm_he_thong?.ten || "Hệ thống chưa xác định"}
                      </p>
                    </div>
                ...
                {lowCompleteness.length === 0 && (
                  <div className="py-8 text-center text-muted-foreground">
                    Tất cả tài sản đã đạt mức hoàn thiện tốt!
                  </div>
                )}
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-3">
                {tasks.map((task: any) => (
                  <div
                    key={task.id}
                    className="p-3 border rounded-lg border-l-4 border-l-primary bg-background shadow-sm"
                  >
