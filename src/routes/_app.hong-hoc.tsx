    ...
    const base: StdColumn<HongHocThayThe>[] = [
      ...
      },
      {
        ...
        cell: (h) => {
          ...
          return tb ? (
            <Link to="/thiet-bi/$maThietBi" params={{ maThietBi: tb.ma_thiet_bi }} search={{ tab: "tong-quan" }} className="text-primary hover:underline">
      ...
      },
      {
        ...
        cell: (h) => {
          ...
          return tbT ? (
            <Link to="/thiet-bi/$maThietBi" params={{ maThietBi: tbT.ma_thiet_bi }} search={{ tab: "tong-quan" }} className="flex items-center gap-1 text-primary hover:underline">
