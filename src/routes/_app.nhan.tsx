        ...
        <PageHeader
          ...
          help={
            <>
              ...
              <code className="mx-1 rounded bg-secondary px-1 text-meta">/q/&lt;mã&gt;</code>{" "}
  ...
  return (
    <div className="label-card flex items-center gap-2 rounded-md border bg-card p-2 text-foreground">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className={cn("truncate font-mono text-meta text-slate-800", showName && "mt-0.5")}>
          {ma}
        </div>
        <div className="mt-0.5 text-nano font-medium tracking-wide text-slate-400">
          MIRATS · VATM
        </div>
      </div>
    </div>
