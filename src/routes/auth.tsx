  ...
  return (
    <div className="space-y-2.5">
      ...
      <Input
        ...
        disabled={disabled}
        className="!h-14 !rounded-2xl border-slate-200 bg-slate-50/30 px-5 !text-base font-medium transition-all focus-within:!ring-4 focus-within:!ring-[#0074e2]/10 focus-within:!border-[#0074e2]/40 focus-within:!bg-white focus-within:!outline-none"
      />
    </div>
  );
}
