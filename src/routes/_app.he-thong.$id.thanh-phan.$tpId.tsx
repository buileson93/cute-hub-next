                ...
                <div className="rounded-md border p-3">
                  ...
                  <div className="mt-3">
                    <Button asChild size="sm" variant="outline">
                      <Link to="/thiet-bi/$maThietBi" params={{ maThietBi: dangLap.ma_thiet_bi }} search={{ tab: "tong-quan" }}>
                      ...
                      <li key={h.gan_id} className="relative mb-4 last:mb-0">
                        ...
                        <div className="rounded-md border p-3 text-sm">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <Link to="/thiet-bi/$maThietBi" params={{ maThietBi: h.ma_thiet_bi }} search={{ tab: "tong-quan" }} className="ml-auto text-xs text-primary hover:underline">
                              Mở →
                            </Link>
                          </div>
