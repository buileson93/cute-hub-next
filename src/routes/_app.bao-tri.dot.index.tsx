  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Đợt bảo dưỡng lớn — MIRATS" },
      {
        ...
        content: "Lập danh mục hệ thống, thu thập kết quả và tổng hợp báo cáo bảo dưỡng theo đợt.",
      },
    ],
  }),
...
const trangThaiLabel: Record<string, { label: string; color: string }> = {
  nhap: { label: "Nháp", color: "bg-muted text-slate-700" },
                ...
                <Card className="transition hover:border-primary hover:shadow-sm">
                  <CardHeader className="pb-2">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <Badge className={tt.color} variant="secondary">
                        {tt.label}
                      </Badge>
                    </div>
...
function NewDotDialog({
  ...
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Tạo đợt bảo dưỡng lớn</DialogTitle>
      </DialogHeader>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => {
                setKy(Number(v));
                setTen(`Đợt bảo dưỡng lớn kỳ ${v}/${nam}`);
              }}
            >
              <SelectTrigger>
                <SelectValue />
        ...
        <Button
          ...
          onClick={() =>
            onSubmit({
              ...
              nam,
              ky,
              tu_ngay: tu || undefined,
              den_ngay: den || undefined,
