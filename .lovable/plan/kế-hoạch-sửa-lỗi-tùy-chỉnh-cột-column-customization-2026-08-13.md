...
_Lý do_: Phương án A (cho phép thắng) sẽ làm vỡ layout bảng trên mobile/tablet, gây tràn ngang cực khó chịu và vi phạm nguyên tắc "Responsive by default" của MIRATS 2.0. Việc thông báo rõ giúp người dùng không cảm thấy bị "im lặng", đồng thời giáo dục người dùng về tính năng tự động tối ưu không gian.
