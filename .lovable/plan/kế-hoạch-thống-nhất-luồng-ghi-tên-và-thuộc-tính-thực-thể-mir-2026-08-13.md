...
- Thay vì hiện "Đã lưu", hệ thống sẽ hiện thông báo màu vàng: _"Đã tạo đề xuất thay đổi tên từ 'A' thành 'B'. Đang chờ Admin phê duyệt."_
- Nút "Hủy đề xuất" sẽ xuất hiện ngay cạnh ô nhập liệu nếu có đề xuất đang treo.

---

_Lưu ý: Không thay đổi lược đồ (schema) database, không xóa bảng `cay_node_edit`._
