...
- Cập nhật `src/components/mirats/he-thong-cay/CayMindMap.tsx`:
  ...
  - Sửa `useEffect` đồng bộ: Chỉ tự động expand khi dữ liệu cây _thực sự_ thay đổi cấu trúc lớn (ví dụ: thay đổi số lượng phân loại), tránh reset khi chỉ cập nhật thông tin node.
