...
- **Primary:** Tên (ten) - *Lý do: Thông tin nhận diện chính.*
- **Secondary:** Mã (ma), Tài sản (soThietBi), Trạng thái (active) - *Lý do: Thông tin quan trọng cần xem nhanh.*
- **Detail:** Mô tả (mo_ta), Logo, Xuất xứ (xuat_xu), Ghi chú (ghi_chu) - *Lý do: Thông tin bổ trợ, dài dòng.*

#### B. ThanhPhanTable.tsx (Bảng thành phần/tài sản)
- **Primary:** Tên tài sản/thành phần (ten), Mã (ma) - *Lý do: Key chính để tìm kiếm.*
- **Secondary:** Trạng thái (trangThai), Vị trí (viTri), Serial - *Lý do: Dữ liệu vận hành hay dùng.*
- **Detail:** P/N, Hạn bảo hành, Nhà sản xuất, Danh sách hệ thống/thành phần đang lắp - *Lý do: Dữ liệu kỹ thuật chi tiết, chiếm nhiều diện tích.*

#### C. NetworkOverview.tsx (Dữ liệu liên kết mạng)
- **Primary:** Tên hệ thống/thành phần nguồn-đích - *Lý do: Xác định liên kết.*
- **Secondary:** Loại liên kết (loai_ten), Giao thức (giao_thuc), Trạng thái (trang_thai).
- **Detail:** Ghi chú, Giao diện nguồn/đích, Trọng số - *Lý do: Thông tin phụ trợ.*
