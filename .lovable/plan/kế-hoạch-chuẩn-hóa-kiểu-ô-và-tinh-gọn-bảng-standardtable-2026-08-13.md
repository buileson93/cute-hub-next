...
1.  **Gộp Cụm Mã (Identities):** Số serial + Mã Bravo + P/N → Cột "Định danh".
    - _Hiển thị:_ Mã Bravo (chính), SN & P/N (dòng 2 nhỏ hoặc tooltip).
    - _Mở rộng:_ Xem đủ 3 mã ở Row Expansion.
2.  **Gộp Cụm Không gian (Space):** Hệ thống + Đơn vị + Vị trí → Cột "Vị trí lắp đặt".
    - _Hiển thị:_ Cấp cuối (Vị trí), Đơn vị & Hệ thống (tooltip/breadcrumb).
3.  **Gộp Cụm Phân loại (Taxonomy):** Chủng loại + Phân loại + Nhóm hệ thống → Cột "Phân loại".
    - _Hiển thị:_ Chủng loại (MauChip), các phần còn lại ở Row Expansion.
