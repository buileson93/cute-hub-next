...
*Mục tiêu: Xoá bỏ 579 vị trí màu hardcode, hỗ trợ Dark Mode hoàn chỉnh và nhất quán trạng thái.*
...
*Mục tiêu: Tối ưu hoá bảng nặng nhất hệ thống.*
...
*Mục tiêu: Giải cứu file trung tâm của dự án.*
...
*Mục tiêu: Nhất quán 5 trang Kiểm định, Tuổi thọ, Giấy phép, Bàn giao, Vật tư.*
...
*Mục tiêu: Xử lý sự trùng lặp giữa Dashboard (Home) và Trang tổng quan.*
...
*Mục tiêu: Đơn giản hoá các form >800 dòng và chuẩn hoá layout.*
