...
- **Unified Work View**: We are standardizing the *visual* language for PM and Maintenance tasks, but the database tables remain separate to preserve data integrity.
