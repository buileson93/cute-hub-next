CREATE OR REPLACE FUNCTION public.backup_schema_json()
 RETURNS jsonb
 LANGUAGE plpgsql
...
REVOKE ALL ON FUNCTION public.backup_schema_json() FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.backup_schema_json() TO authenticated, service_role;