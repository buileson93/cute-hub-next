-- Drop existing views first to avoid column renaming errors
DROP VIEW IF EXISTS public.v_tai_san_toan_cuc;
DROP VIEW IF EXISTS public.v_thanh_phan_toan_cuc;

-- 1. Recreate View for Asset Overview (v_tai_san_toan_cuc)
...
-- 2. Recreate View for System Components (v_thanh_phan_toan_cuc)
