...
-- Function để tính độ hoàn thiện
...
-- Cập nhật dữ liệu hiện tại (fix syntax)
...
GRANT SELECT ON public.thiet_bi TO authenticated;
GRANT SELECT ON public.dm_he_thong TO authenticated;
GRANT SELECT ON public.nhiem_vu_nhap_lieu TO authenticated;
GRANT SELECT ON public.dong_gop_diem TO authenticated;
